const stories = [
    ...
    },
    {
        ...
        "author": "Aesop's Fables",
        "story": "The Mice once called a meeting to decide on a plan to free themselves of their enemy, the Cat. At least they wished to find some way of knowing when she was coming, so they might have time to run away. Indeed, something had to be done, for they lived in such constant fear of her claws that they hardly dared stir from their dens by night or day.  Many plans were discussed, but none of them was thought good enough. At last a very young Mouse got up and said:  \"I have a plan that seems very simple, but I know it will be successful.  All we have to do is to hang a bell about the Cat's neck. When we hear the bell ringing we will know immediately that our enemy is coming.\"  All the Mice were much surprised that they had not thought of such a plan before. But in the midst of the rejoicing over their good fortune, an old Mouse arose and said:  \"I will say that the plan of the young Mouse is very good. But let me ask one question: Who will bell the Cat?\"",
    ...
    },
    {
        ...
        "author": "Aesop's Fables",
        "story": "A Gnat flew over the meadow with much buzzing for so small a creature and settled on the tip of one of the horns of a Bull. After he had rested a short time, he made ready to fly away. But before he left he begged the Bull's pardon for having used his horn for a resting place.  \"You must be very glad to have me go now,\" he said.  \"It's all the same to me,\" replied the Bull. \"I did not even know you were there.\"",
    ...
    },
    {
        ...
        "author": "Aesop's Fables",
        "story": "Two Travellers, walking in the noonday sun, sought the shade of a widespreading tree to rest. As they lay looking up among the pleasant leaves, they saw that it was a Plane Tree.  \"How useless is the Plane!\" said one of them. \"It bears no fruit whatever, and only serves to litter the ground with leaves.\"  \"Ungrateful creatures!\" said a voice from the Plane Tree. \"You lie here in my cooling shade, and yet you say I am useless! Thus ungratefully, O Jupiter, do men receive their blessings!\"",
    ...
    },
    {
        ...
        "author": "Aesop's Fables",
        "story": "Hares, as you know, are very timid. The least shadow, sends them scurrying in fright to a hiding place. Once they decided to die rather than live in such misery. But while they were debating how best to meet death, they thought they heard a noise and in a flash were scampering off to the warren. On the way they passed a pond where a family of Frogs was sitting among the reeds on the bank. In an instant the startled Frogs were seeking safety in the mud. \"Look,\" cried a Hare, \"things are not so bad after all, for here are creatures who are even afraid of us!\"",
    ...
    },
    {
        ...
        "author": "Aesop's Fables",
        "story": "A Crab one day grew disgusted with the sands in which he lived. He decided to take a stroll to the meadow not far inland. There he would find better fare than briny water and sand mites. So off he crawled to the meadow. But there a hungry Fox spied him, and in a twinkling, ate him up, both shell and claw.",
    ...
    },
    {
        ...
        "author": "Aesop's Fables",
        "story": "A Fox, swimming across a river, was barely able to reach the bank, where he lay bruised and exhausted from his struggle with the swift current. Soon a swarm of blood-sucking flies settled on him; but he lay quietly, still too weak to run away from them. A Hedgehog happened by. \"Let me drive the flies away,\" he said kindly. \"No, no!\" exclaimed the Fox, \"do not disturb them! They have taken all they can hold. If you drive them away, another greedy swarm will come and take the little blood I have left.\"",
        "moral": "Better to bear a lesser evil than to risk a greater in removing it."
    },
    {
        "_id": "5fcdd94c30fb4e5a5aa3aa46",
    ...
    },
    {
        ...
        "author": "Aesop's Fables",
        "story": "Some hungry Dogs saw a number of hides at the bottom of a stream where the Tanner had put them to soak. A fine hide makes an excellent meal for a hungry Dog, but the water was deep and the Dogs could not reach the hides from the bank. So they held a council and decided that the very best thing to do was to drink up the river. All fell to lapping up the water as fast as they could. But though they drank and drank until, one after another, all of them had burst with drinking, still, for all their effort, the water in the river remained as high as ever.",
    ...
    },
    {
        ...
        "author": "Aesop's Fables",
        "story": "A Boy, stung by a Nettle, ran home crying, to get his mother to blow on the hurt and kiss it. \"Son,\" said the Boy's mother, when she had comforted him, \"the next time you come near a Nettle, grasp it firmly, and it will be as soft as silk.\"",
    ...
    },
    {
        ...
        "author": "Aesop's Fables",
        "story": "A Wolf left his lair one evening in fine spirits and an excellent appetite. As he ran, the setting sun cast his shadow far out on the ground, and it looked as if the wolf were a hundred times bigger than he really was. \"Why,\" exclaimed the Wolf proudly, \"see how big I am! Fancy me running away from a puny Lion! I'll show him who is fit to be king, he or I.\" Just then an immense shadow blotted him out entirely, and the next instant a Lion struck him down with a single blow.",
    ...
    },
    {
        ...
        "author": "Aesop's Fables",
        "story": "A certain man who visited foreign lands could talk of little when he returned to his home except the wonderful adventures he had met with and the great deeds he had done abroad. One of the feats he told about was a leap he had made in a city Called Rhodes. That leap was so great, he said, that no other man could leap anywhere near the distance. A great many persons in Rhodes had seen him do it and would prove that what he told was true. \"No need of witnesses,\" said one of the hearers. \"Suppose this city is Rhodes. Now show us how far you can jump.\"",
    ...
    },
    {
        ...
        "author": "Aesop's Fables",
        "story": "A young fellow, who was very popular among his boon companions as a good spender, quickly wasted his fortune trying to live up to his reputation. Then one fine day in early spring he found himself with not a penny left, and no property save the clothes he wore. He was to meet some jolly young men that morning, and he was at his wits' end how to get enough money to keep up appearances. Just then a Swallow flew by, twittering merrily, and the young man, thinking summer had come, hastened off to a clothes dealer, to whom he sold all the clothes he wore down to his very tunic. A few days later a change in weather brought a severe frost; and the poor swallow and that foolish young man in his light tunic, and with his arms and knees bare, could scarcely keep life in their shivering bodies.",
...
generateBtn.addEventListener("click", async()=>{
    document.querySelector('.item2').textContent="Loading...";
    setTimeout (()=>{
        const randomNum = Math.floor(Math.random() * 146);
   document.querySelector('.item2').textContent= stories[randomNum].story ;
    }, 2000);
...
etElementById("generate");
generateBtn.addEventListner("Click", async() => {
    // const res = await fetch("https://shortstories-api.onrender.com/stories");
